$(document).ready(function () {
  ...
  function populateStrings() {
    $("#generalComment").html("<div class='modal-dialog modal-dialog-centered' role='document'>    <div class='modal-content'>      <div class='modal-header'>        <h3 class='modal-title' id='exampleModalCenterTitle'>Leave a General Comment!</h3>        <button type='button' class='close' data-dismiss='modal' aria-label='Close'> <span aria-hidden='true'>&times;</span> </button>      </div>      <div class='modal-body'>        <form id='generalCommentForm' class= 'w-100 h-20 sideContents needs-validation' novalidate>          <div class='form-group'>            <label for='nameFieldgen'>First Name</label>            <input type='text' class='form-control' id='nameFieldgen' placeholder='Optional' name='nameField'>  <label for='lastnameFieldgen'>Last Name</label>            <input type='text' class='form-control' id='lastnameFieldgen' placeholder='Optional' name='lastnameFieldgen'>             <label for='emailFieldgen'>Email</label>            <input type='text' class='form-control' id='emailFieldgen' placeholder='Optional' name='emailField'>            <label for='zipFieldgen'>Zip Code</label>            <input type='text' class='form-control' id='zipFieldgen' placeholder='Optional' name='zipFieldgen'>  <label for='townFieldgen'>Organization</label>            <input type='text' class='form-control' id='townFieldgen' placeholder='If applicable' name='townField'>          </div>          <div class='form-group'>  <label for='catFieldgen'>Select the topic that corresponds the most to your comment</label> <select class='form-control' id='catSelect' required>				<option value='' disabled selected>Please choose one</option></select><div class='invalid-feedback'> Please select a topic.</div><label for='commentFieldgen'>Comments</label>            <textarea class='form-control' id='commentFieldgen' placeholder='Enter your comments here' name='commentField' required></textarea>            <div class='invalid-feedback'> Please enter a comment in the textarea. </div>          </div>          <button class='btn btn-primary btn-block' id='submitCommentgen' type='submit'>Submit Comment</button>          <div class='alert alert-warning string general_comment_issue' role='alert' style='display: none'> </div>        </form>      </div>      <div class='alert alert-success string comment_success' role='alert' style='display: none' > </div>      <div class='modal-footer'>        <button type='button' class='btn btn-secondary' data-dismiss='modal'>Close</button>      </div>    </div>  </div>")	  
    ...
    $("#comment_success_message").html(strings.comment_confirmed);
    $("#comment_failure_message").html(strings.comment_failed);
