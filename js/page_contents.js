$(document).ready(function () {
  ...
  function populateStrings() {
    ...
    $(".page_help").text(config.strings.help_message);
    $(".comment_issue").text(config.strings.comment_failed);
    $(".comment_success").text(config.strings.comment_confirmed);
    $(".project_comment_failure").text(config.strings.comment_failed);
    $(".project_comment_success").text(config.strings.comment_confirmed);
  }
